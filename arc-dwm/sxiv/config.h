 ...
 */
static const char * const BAR_FONT = "Sans:size=9";

/* colors:
 * (see X(7) section "COLOR NAMES" for valid values)
 */
static const char * const WIN_BG_COLOR = "#383C4A";
static const char * const WIN_FS_COLOR = "#CED5DE";
static const char * const SEL_COLOR    = "#EEEEEE";
static const char * const BAR_BG_COLOR = "#252730";
static const char * const BAR_FG_COLOR = "#4084D6";
